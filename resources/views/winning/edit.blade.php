            ...
            <form action="{{url('/winning/update/'.base64_encode($winning->id))}}" method="post">
                ...
                <div class="modal-body">
                    <table class="table table-stripped">
                        ...
                        <tr>
                            <th>Game No.</th>
                            <td><input type="text" name="game_no" value="{{$winning->game_no}}" placeholder="Gamae no." class="form-control"> </td>
                        </tr>

                        <tr>
                            <th>Winning Date</th>
                            <td><input type="text" name="winning_date" value="{{$winning->winning_date}}" placeholder="Winning Date" class="form-control"> </td>
                        </tr>

                        <tr>
                            <th>Winning Time</th>
                            <td><input type="text" name="winning_time" value="{{$winning->winning_time}}" placeholder="Winning Time" class="form-control"> </td>
                        </tr>
                            ...
                            <td>
                                <select name="game_names_id" required="" class="form-control">
                                    ...
                                    @foreach($GameNames as $gameName)
                                        <option value="{{$gameName->id}}" @if($gameName->id == $winning->game_name->id) selected @endif>{{$gameName->name}}</option>
                                    @endforeach
                                </select>
                            </td>
                        </tr>
                            ...
                            <td>
                                <select name="game_types_id" required="" class="form-control">
                                    ...
                                    @foreach($GameTypes as $gameType)
                                        <option value="{{$gameType->id}}" @if($gameType->id == $winning->game_type->id) selected @endif>{{$gameType->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <td>
                                <select name="game_type_options_id" required="" class="form-control">
                                    ...
                                    @foreach($GameTypeOptions as $gameTypeOption)
                                        <option value="{{$gameTypeOption->id}}" @if($gameTypeOption->id == $winning->game_type_option->id) selected @endif>{{$gameTypeOption->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <td>
                                <select name="game_quaters_id" required="" class="form-control">
                                    ...
                                    @foreach($GameQuaters as $gameQuater)
                                        <option value="{{$gameQuater->id}}" @if($gameQuater->id == $winning->game_quater->id) selected @endif>{{$gameQuater->name}}</option>
                                    @endforeach
                                </select>
